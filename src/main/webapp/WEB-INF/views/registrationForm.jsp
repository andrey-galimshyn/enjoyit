        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <form:form action="${pageContext.request.contextPath}/user/register" commandName="user" method="POST" enctype="utf8" role="form">
                    ...
                    <div class="row">
                        <div id="form-group-ssoid" class="form-group col-lg-4">
                            <label class="control-label" for="user-ssoid"><spring:message code="label.user.ssoid"/>:</label>
                            <form:input id="user-ssoid" path="ssoid" cssClass="form-control"/>
                            <form:errors id="error-ssoid" path="ssoid" cssClass="help-block"/>
                        </div>
                    </div>
                    <c:if test="${user.signInProvider == null}">
                        <div class="row">
